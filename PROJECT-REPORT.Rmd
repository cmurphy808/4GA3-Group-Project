...
popDensity <- ggplot() +
  ...
  theme_void() + ggtitle("Population Density") +
...
LowIncomePercent <- ggplot() +
  ...
  scale_fill_viridis(direction = -1,
                     option = "D",
                     name = "Percent") +
  theme_void() + ggtitle("Percentage of Low Income Individuals by Neighbourhood") +
  theme(plot.title = element_text(hjust = 0.5)) #centers the title
LowIncomePercent
```
...
visibleMinorityPercent <- ggplot() +
  ...
  scale_fill_viridis(direction = -1,
                     option = "D",
                     name = "Percent") +
  theme_void() +  ggtitle("Percentage of Visible Minorities by Neighbourhood") +
  theme(plot.title = element_text(hjust = 0.5)) #centers the title
...
youngPercent <- ggplot() +
  ...
  scale_fill_viridis(direction = -1,
                     option = "D",
                     name = "Percent") +
  theme_void() + ggtitle("Percentage of Inhabitants aged 15-29 by Neighbourhood") +
  theme(plot.title = element_text(hjust = 0.5)) #centers the title
youngPercent
```
...
#all factors are combined into 'the below map'aggregated property crim rates'
...
propCrime2016 <- ggplot() +
  ...
  scale_fill_viridis(direction = -1,
                     option = "D",
                     name = "Rate per 100k") +
  theme_void() + ggtitle("Aggregated Property Crime Rates (2016)") +
  theme(plot.title = element_text(hjust = 0.5)) #centers the title
propCrime2016
```
...
propCrime2016TF <- ggplot() + geom_sf(data = TO_crime, aes(fill = propertyCrime2016TF)) + labs(title = "Neighbourhood Crime Rates Relative to Mean Crime Rates (2016)") + labs(fill = "Crime Rate Above City Mean")
propCrime2016TF
```
```{r}
...
moran.plot(TO_crime$propertyCrime2016, TO_crime.w)
...
summary(model1)
plot(TO_crime$propertyCrime2016 ~ TO_crime$low_income_percent, main = "Property Crime Rate and Percentage of Low Income Individuals of Toronto Neighbourhoods", xlab = "Percentage of Low Income Individuals", ylab = "Neighbourhood Property Crime Rate", pch = 16) + abline(model1, col = "red")
 
model2 <- lm(formula = TO_crime$propertyCrime2016 ~ TO_crime$total_visible_minority, data = TO_crime)
summary(model2)
plot(TO_crime$propertyCrime2016 ~ TO_crime$visible_minority_percent, main = "Property Crime Rate and Percentage of Visible Minority Individuals of Toronto Neighbourhoods", xlab = "Percentage of Visible Minority Individuals", ylab = "Neighbourhood Property Crime Rate", pch = 16) + abline(model2, col = "red")

model3 <- lm(formula = TO_crime$propertyCrime2016 ~ TO_crime$percent_aged_15to29, data = TO_crime)
summary(model3)
plot(TO_crime$propertyCrime2016 ~ TO_crime$total_pop_aged_15to29, main = "Property Crime Rate and Percentage of Youth (15-29) of Toronto Neighbourhoods", xlab = "Percentage of Youth Aged 15-29", ylab = "Neighbourhood Property Crime Rate", pch = 16) + abline(model3, col = "red")

model4 <- lm(formula = TO_crime$propertyCrime2016 ~ TO_crime$population_density, data = TO_crime)
summary(model4)
plot(TO_crime$propertyCrime2016 ~ TO_crime$population_density, main = "Property Crime Rate and Population Density of Toronto Neighbourhoods", xlab = "Neighbourhood Population Density", ylab = "Neighbourhood Property Crime Rate", pch = 16) + abline(model4, col = "red")
```

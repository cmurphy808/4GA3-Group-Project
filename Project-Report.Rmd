...
propCrime2020 <- ggplot() +
  ...
  scale_fill_viridis(direction = -1,
                     ...
                     name = "Rate per 100k") +
  theme_void() +
  ggtitle("Property Crime Rate 2020")
...
break_enter2020 <- ggplot() +
  ...
  scale_fill_viridis(direction = -1,
                     ...
                     name = "Rate per 100k") +
  theme_void() +
  ggtitle("Break and Enter Rates, 2020")
...
robbery2020 <- ggplot() +
  ...
  scale_fill_viridis(direction = -1,
                     ...
                     name = "Rate per 100k") +
  theme_void() +
  ggtitle("Robbery Rates, 2020")

# theft over $2000 (grand larceny) map
theftOver2020 <- ggplot() +
  ...
  scale_fill_viridis(direction = -1,
                     ...
                     name = "Rate per 100k") +
  theme_void() +
  ggtitle("Theft Over $2000 Rates, 2020")
